...
/** A thin red light under the top bar while data loads. It waits 150 ms before showing so
      ...
      <AnimatePresence>
        {fetching && (
          <m.div
            ...
            className="h-full w-1/3 bg-[linear-gradient(90deg,transparent,var(--glow),transparent)] glow-icon"
